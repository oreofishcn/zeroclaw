...
impl Agent {
    ...
    pub fn from_config(config: &Config) -> Result<Self> {
        ...
        let tools = tools::default_tools_with_runtime(security.clone(), runtime);
        ...
        let provider: Box<dyn Provider> = providers::create_provider(
            provider_name,
        ...
        Agent::builder()
            ...
            .route_model_by_hint(HashMap::new())
            .identity_config(crate::config::IdentityConfig)
            .skills(Vec::new())
            .skills_prompt_mode(crate::config::SkillsPromptInjectionMode::Disabled)
            .auto_save(false)
            .build()
    }
...
mod tests {
    use super::*;
    #[test]
    fn from_config_builds_minimal_agent() {
